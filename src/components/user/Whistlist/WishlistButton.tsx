...
const WishlistButton: React.FC<WishlistButtonProps> = ({
  ...
  return (
    <button
      onClick={handleClick}
      className={`wishlist-button relative p-2 text-gray-900`}
      title="Wishlist">
      <Icon
        icon="lucide:heart"
        width="20"
      ...
      {!isLoading && wishlistCount > 0 && (
        <span className="wishlist-count-badge absolute -top-1 -right-1 bg-red-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center font-medium">
