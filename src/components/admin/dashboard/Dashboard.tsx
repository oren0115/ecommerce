...
const Dashboard: React.FC<DashboardProps> = () => {
  ...
  return (
    <div className="p-4">
      ...
      {/* Metrics Grid */}
      <div className="mb-6 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
            ...
            <CardBody className="p-6">
              <div className="flex items-start justify-between">
                ...
                <div className="p-2 bg-white/20 rounded-lg">
                  <Icon icon={metric.icon} className="w-6 h-6 text-gray-600" />
                </div>
              </div>
            </CardBody>
          </Card>
      ...
      {/* Quick Actions */}
      <Card className="bg-white/70 backdrop-blur-sm border-gray-100/50 mb-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {quickActions.map((action, index) => (
              <Button
                ...
                color={action.color}
                variant="bordered"
                className={`group flex flex-col items-center p-6 h-auto border-gray-100/80 hover:border-gray-200 transition-all duration-300 ${action.hoverBgColor}`}
                onPress={() => navigate(action.path)}>
                <div
                  className={`p-3 rounded-xl ${action.bgColor} group-hover:${action.hoverBgColor} transition-colors duration-300 mb-3`}>
                  <Icon
                    icon={action.icon}
